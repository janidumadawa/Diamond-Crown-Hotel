...
const GalleryManagement = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      >
        <h3 className={`${michroma.className} text-xl font-bold text-[#2d2a32] mb-4`}>
      ...
      <motion.div
        ...
        className="bg-white rounded-xl shadow-lg border border-[#2d2a32]/10 p-6"
      >
        <h3 className={`${michroma.className} text-xl font-bold text-[#2d2a32] mb-6`}>
        ...
        {images.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {images.map((image, index) => (
              <div key={image._id} className="border border-[#2d2a32]/10 rounded-lg overflow-hidden">
                <div className="bg-[#f9f9f9] border-b border-[#2d2a32]/10">
                  <div className="text-center p-4">
                    <div className="text-lg font-semibold text-gray-700 mb-2">{image.title}</div>
                    <div className="text-sm text-gray-500">Image {index + 1}</div>
                    {/* display image */}
                    <img
