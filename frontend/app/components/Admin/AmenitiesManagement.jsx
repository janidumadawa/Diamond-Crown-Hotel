//D:\visual studio program\Diamond-Crown-Hotel\frontend\app\components\Admin\AmenitiesManagement.jsx
"use client";
    ...
    <div className="bg-white p-6 rounded-lg">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600">Manage hotel amenities and services</p>
        </div>
        <button
              ...
              <div className="flex gap-6">
                ...
                <div className="flex-shrink-0">
                  <img
                    ...
                    onError={(e) => {
                      console.log("Image failed to load:", amenity.image);
